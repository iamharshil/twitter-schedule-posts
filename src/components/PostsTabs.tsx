									...
									>
										<div className="flex items-start justify-between">
											<div className="flex-1 min-w-0">
												...
												<p className="text-slate-900 dark:text-white leading-relaxed text-base mb-4">
													{post.content}
												</p>
											</div>
											<div className="flex items-center gap-2 ml-6">
												...
												<Button
													variant="ghost"
													size="sm"
													className="h-9 w-9 p-0 text-red-500 hover:text-red-700 hover:bg-red-50 cursor-pointer"
													onClick={() => onDelete(post.id)}
												>
